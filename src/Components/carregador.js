...
const Carregador = () => {
  ...
  return (
    <div>
      <button onClick={() => setShowCarregador("true")} className="Carregar">
        Carregar Mais
      </button>
      ...
      {showCarregador === "true" && (
        <form className="ContainerInputs" onSubmit={sumbit}>
          ...
          <input
            ...
            onChange={handleInputChange}
            name="img"
            placeholder=" /direct link/ size=195x293 "
            className="inputCarregar"
          ></input>
          <input
            id="PRICE"
          ...
          <input
            ...
            className="inputCarregar"
          ></input>
          <button onClick={sumbit} type="sumbit" className="Carregar">
            Carregar
          </button>
        </form>
      )}
